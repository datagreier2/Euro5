        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-12 pr-8 py-3 bg-neutral-800 border border-neutral-700 text-neutral-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent appearance-none min-w-40 font-light tracking-wide"
            >
          ...
          <div className="relative">
            <select
              ...
              className="pl-4 pr-8 py-3 bg-neutral-800 border border-neutral-700 text-neutral-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent appearance-none min-w-40 font-light tracking-wide"
            >
              {sources.map(source => (
                <option key={source} value={source} className="bg-neutral-800">{source}</option>
              ))}
            </select>
          </div>
        </div>
