...
const valueIconClasses = 'w-10 h-10 text-amber-400 mb-4';
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
      <section className="text-center space-y-6">
        <h2 className="text-4xl sm:text-5xl font-serif text-neutral-100 tracking-wide">
          {t('aboutPage.heroTitle')}
        </h2>
        <p className="text-neutral-300 font-light leading-relaxed max-w-3xl mx-auto">
          {t('aboutPage.heroSubtitle')}
        </p>
      </section>

      <section className="bg-neutral-900 border border-neutral-800 p-8 sm:p-10">
      ...
      <section>
        <h3 className="text-2xl font-serif text-neutral-100 mb-8 tracking-wide text-center">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {values.map(({ key, title, body, Icon }) => (
            <article
              key={key}
              className="bg-neutral-900 border border-neutral-800 p-6 flex flex-col h-full"
            >
              <Icon className={valueIconClasses} />
              <h4 className="text-xl font-serif text-neutral-100 mb-3">{title}</h4>
              <p className="text-neutral-300 font-light leading-relaxed">{body}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section className="grid gap-8 md:grid-cols-2">
        ...
        <div className="bg-neutral-900 border border-neutral-800 p-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-amber-400 hover:text-amber-300 transition-colors font-serif"
          >
